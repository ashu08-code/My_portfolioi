  ...
  return (
    <section className="text-white">
      ...
      • Bachelor of Technology
        ...
        I completed my graduation in 2024 with 7.9 CGPA </p> */}
        ...
        Shivajirao Kadam Institute of Technology and Management, Indore
          ...
          <p className="text-[#ADB7BE] text-base sm:text-md mb-6 lg:text-lg">I completed my graduation in 2024 with 7.9 CGPA</p>
